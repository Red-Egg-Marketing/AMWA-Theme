...
const template = [
	...
	['amwa-theme-block/lessons', {}],
];

const EditSelectedLessons = ( { attributes, setAttributes, clientId } ) => {
		...
		return (
			<Fragment>
				...
				<div {...blockProps}>
					<InnerBlocks
						template={ template }
						allowedBlocks={ ['amwa-theme-block/header-intro', 'amwa-theme-block/lessons', 'core/buttons'] }
					/>
				</div>
			</Fragment>
		);
