 ...
 * SVG Upload support
 **/
function amwa_theme_svgs_disable_real_mime_check( $data, $file, $filename, $mimes ) {
...
add_filter( 'wp_check_filetype_and_ext', 'amwa_theme_svgs_disable_real_mime_check', 10, 4 );

function amwa_theme_mime_types($mimes) {
 $mimes['svg'] = 'image/svg+xml';
 return $mimes;
}
add_filter('upload_mimes', 'amwa_theme_mime_types');
